...
# Contents
[1. 기본 개념](#1------) <br/>
[2. Frequentist와 Bayesian의 차이](#2-frequentist--bayesian----) <br/>
[3. 베이지안 추론](#3--------) <br/>
[4. 계층 모형](#4------) <br/>
[5. 베이지안 회귀](#5--------) <br/>
[6. 마코브체인 몬테카를로 시뮬레이션](#6------------------) <br/>
[7. JAGS를 통한 시뮬레이션 연습](#7-jags-------------) <br/>
...
# [2. Frequentist와 Bayesian의 차이](#2-frequentist--bayesian----)
